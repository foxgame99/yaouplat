...
namespace Yaouplat.Strategy.AspNetCache
{
	public class AspNetCache : ICache, IStrategy
	{
		...
		public void Recieve<T>(string key, Himall.Core.Cache.DoSub dosub)
		{
		}

		public void RegisterSubscribe<T>(string key, Himall.Core.Cache.DoSub dosub)
		{
		}
